...
|:---|---:|---:|---:|
| `target/release/p01 < input/p01.txt` | 4.4 ± 1.3 | 3.2 | 6.4 |
| `target/release/p02 < input/p02.txt` | 14.9 ± 1.6 | 12.5 | 18.1 |
| `target/release/p03 < input/p03.txt` | 0.9 ± 0.1 | 0.7 | 1.0 |
| `target/release/p04 < input/p04.txt` | 18.3 ± 0.3 | 18.0 | 19.0 |
| `target/release/p05 < input/p05.txt` | 0.9 ± 0.2 | 0.7 | 1.3 |
| `target/release/p06 < input/p06.txt` | 0.8 ± 0.2 | 0.6 | 1.2 |
| `target/release/p07 < input/p07.txt` | 1.0 ± 0.1 | 0.9 | 1.1 |
| `target/release/p08 < input/p08.txt` | 20.5 ± 0.4 | 20.0 | 21.5 |
| `target/release/p09 < input/p09.txt` | 24.3 ± 0.3 | 23.7 | 24.9 |
| `target/release/p10 < input/p10.txt` | 280.5 ± 7.1 | 275.2 | 299.2 |
